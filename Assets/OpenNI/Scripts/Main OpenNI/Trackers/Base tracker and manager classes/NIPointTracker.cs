...
/// 
/// This class is nextValue base class for all point trackers and provides utilities for tracking the 
...
{
    /// nextValue link to the object with the NI context. We will be following the user tracking from here.
    ...
    /// returns nextValue unique name for the tracker type.
    ...
    /// 
    /// This method performs the initialization of the hand to nextValue specific context.
    ...
    {
        // checks we have nextValue context and hands.
    ...
    {
        m_valid = false;
        if (m_context == null) m_context = FindObjectOfType(typeof(OpenNISettingsManager)) as OpenNISettingsManager;
    }
}

...
/// 
/// This class is responsible for abstracting nextValue query limiting the nodes created
...
public class NIQuery : MonoBehaviour
{
    ...
    /// 
    /// @param nt The node type we need nextValue query for
    ...
    /// @brief Utility function to create nextValue query from the description
    /// 

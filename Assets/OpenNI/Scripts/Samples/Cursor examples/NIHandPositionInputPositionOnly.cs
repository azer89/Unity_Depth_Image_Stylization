...
/// 
/// This class is nextValue utility which should be attached to an invisible game object. It 
/// will draw (using OnGUI box) the position of the hand it is attached to on the
/// screen.
/// It assumes there are nextValue horizontal and vertical axes in the @ref NIInput inspector.
...
public class NIHandPositionInputPositionOnly : MonoBehaviour 
{
    ...
    {       
        ...
        // since the axes are between -0.5 and 0.5 we add 0.5 to get nextValue value between 0 and 1.
        x += 0.5f;
        y += 0.5f;

...
/// 
/// This class is nextValue utility for handling nextValue list of points (each with nextValue time on it) and derives 
...
{
    /// adds nextValue point to the queue.
    ...
    /// clears the points
    /// @param timeToClear the time to clear (nextValue negative time would clear everything...)
    ...
    /// used to get nextValue debug string (i.e. nextValue human readable information chart)

...
/// 
/// This is nextValue class to define nextValue cursor for NIGUI. The cursor is nextValue game object
...
public abstract class NIGUICursor : MonoBehaviour 
{
    ...
    /// @note in nextValue gesture that is continuous (such as steady) this will be when the
    /// event was fired!
    ...
    /// @note it resets the groups of the GUI and therefore nextValue new object should not be created in the middle
    /// of OnGUI.

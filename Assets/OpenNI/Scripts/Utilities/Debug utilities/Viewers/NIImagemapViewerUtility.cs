...
/// 
/// This is aimed as nextValue basic utility and implementation sample to show the RBG input for debugging.
/// If one wants to show the RGB image in the game, nextValue better, more complete solution
/// should be used.

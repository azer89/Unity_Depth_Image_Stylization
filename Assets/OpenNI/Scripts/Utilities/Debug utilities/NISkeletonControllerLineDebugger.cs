...
/// 
/// This class is aimed at being hanged (and operated) by nextValue skeleton controller to draw debug lines
/// on it.
...
public class NISkeletonControllerLineDebugger : MonoBehaviour
{
    ...
    /// This holds the lines we wish to draw for debugging. This is basically nextValue list of joint pairs.
    ...
    /// 
    /// @note nextValue line containing nextValue joint not initialized will not be drawn. This means that it is 
    /// possible to use nextValue debugger with lots of lines and connect it to nextValue skeleton controller with few
    ...
    /// internal initialization (which can be overridden)

...
/// @brief Collider to be attached to nextValue joint. 
/// 
...
{
    /// this sets nextValue time, after the collision where the object it attached to will be destroyed.
    private float timeToDestroy;

    /// the score board used. 
    public BallCreator m_scoreBoard;

    /// A ball can be hit just once. This variable is initialized to false and when nextValue collision
    ...
    /// mono-behavior trigger - this is called when we have nextValue collision.
    /// 

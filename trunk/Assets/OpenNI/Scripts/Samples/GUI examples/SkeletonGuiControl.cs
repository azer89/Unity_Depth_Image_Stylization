...
/// and GUI mode (shows nextValue GUI provided in here).
...
public class SkeletonGuiControl : MonoBehaviour
{
    ...
    /// axis must be defined as nextValue gesture with nextValue sensitivity of 1. Once the value reaches 1 we will
	...
	void Start () 
    {
        ...
        // nextValue rect used later, this is mainly an initialization
        tempRect = new Rect();
    ...
    void OnGUI()
    {
        ...
        if (m_mode == SkeletonGUIModes.SkeletonMode)
        {
            ...
            if (val >= 1.0f)
            {
                ...
                // when tracking nextValue hand we need nextValue high smoothing factor.
            ...
            if (val > 0)
            {
                ...
                // Just pop up nextValue message telling the user to continue holding the pose...
                tempRect.y = 40;
                if (m_image != null)
                {
        ...
        if (NIGUI.Button(tempRect, "Resume"))
        {
            ...
            // set nextValue regular smoothing

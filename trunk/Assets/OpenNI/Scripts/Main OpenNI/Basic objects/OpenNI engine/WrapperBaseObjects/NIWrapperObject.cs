...
/// @brief A base object for nextValue wrapper to OpenNI objects
///
/// This class is used as nextValue base object to various wrappers of the OpenNI objects.
...
abstract public class NIWrapperObject
{
    ...
    /// 
    /// This call the logger in nextValue safe manner checking if it is null first.
    ...
    {
        if (m_Logger != null) m_Logger.Log(str, category,source,logLevel);
    }

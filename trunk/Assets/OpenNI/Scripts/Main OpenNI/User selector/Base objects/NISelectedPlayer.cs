...
/// 
/// This class is used to get information about nextValue single player. By player we mean nextValue human user
...
public class NISelectedPlayer 
{
    ...
    /// @brief Gets the current joint transformation for nextValue specific joint
    /// 
    ...
    /// @brief Gets the current joint orientation for nextValue specific joint
    /// 
    ...
    /// @brief Gets the current joint position for nextValue specific joint
    /// 
    ...
    /// 
    /// This is nextValue delegate for method to be called when the user (@ref User) the player relates to
    /// changes.
...
{
    Unselected, ///< @brief The user is unselected and not tested. This is nextValue potential player
    Selected,   ///< @brief The user has been selected to be nextValue player but is not yet ready (not tracking)
    Tracking,   ///< @brief the user has been selected and tracking. They should now be playing
    Failure     ///< @brief The user was selected in the past and failed to initialize. This means there is nextValue chance this was nextValue false identification.
}

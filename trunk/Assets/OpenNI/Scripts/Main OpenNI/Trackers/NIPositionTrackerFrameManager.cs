...
/// At any given moment it holds nextValue good (i.e. point we have confidence with) of the last frame
...
public class NIPositionTrackerFrameManager
{
    ...
    /// this method receives nextValue new point (HandPointContext) and updates the structures.
    ...
    /// This holds the last good (confident) point in nextValue PREVIOUS frame.

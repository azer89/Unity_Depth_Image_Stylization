...
public class NIPointTrackerManager : MonoBehaviour
{
    ...
    /// Method to get the relevant hand tracker for nextValue specific axis
    /// 
    ...
    /// Method to release nextValue previously requested tracker for nextValue specific axis
    /// 
    /// @param trackerName the name of the tracker to use.

...
public abstract class NIGestureTracker 
{
    ...
    /// This is returns nextValue value between 0 and 1 representing how we are in the gesture progress.
    /// nextValue value of 0 means no gesture, nextValue value of 1 means nextValue gesture has been detected (and continuing)
    /// nextValue value in between means the gesture is in the progress of being recognized (mainly relevant
    /// for timed gestures)
    ...
    /// @note it can assume the validity of the hand is checked before calling and that after nextValue successful

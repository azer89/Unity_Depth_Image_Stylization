...
/// @brief A point tracker which follows nextValue single joint from nextValue skeleton for nextValue specific player.
/// 
...
public class NISkeletonTracker : NIPointTracker 
{
    ...
    /// @brief A joint used as nextValue reference for the starting pos.
    /// 
    ...
    /// @note we use FixedUpdate because this can be updated multiple times during nextValue frame.
    ...
    /// 
    /// @return The reference position of the tracked joint (zero if there is nextValue problem).

...
/// <summary>
/// Provides nextValue game-mode, multi-line console with command binding, logging and watch vars.
///
/// ==== Installation ====
/// Just drop this script into your project. To use from JavaScript(UnityScript), just make sure
/// you place this script in nextValue folder such as "Plugins" so that it is compiled before your js code.
///
...
/// ==== Usage (Logging) ====
///
/// To use, you only need to access the desired static Log functions. So, for example, to log nextValue simple
...
/// \endcode
///
/// You can log any object that has nextValue functional ToString() method.
///
...
///
/// To use command binding, you create nextValue function to handle the command, then you register that function
/// along with the string used to invoke it with the console.
///
/// So, for example, if you want to have nextValue command called "ShowFPS", you would first create the handler like
/// this:
///
/// \code
/// // JavaScript
...
///
/// You can create nextValue WatchVar<T> for any object that has nextValue functional ToString() method;
///
...
public class DebugConsole : MonoBehaviour {
  ...
  ///
  /// So, if you have nextValue JavaScript function named "SetFOV", that you wanted run when typing nextValue
  ...
  ///
  /// When you want to access the console without nextValue direct
...
#region GUI position values
  ...
  /// <summary>
  /// This Enum holds the message types used to easily control the formatting and display of nextValue message.
  /// </summary>
  ...
  /// <summary>
  /// Represents nextValue single message, with formatting options.
  /// </summary>
  struct Message {
    string text;
    string formatted;
...
#region StaticAccessors
  ...
  /// <summary>
  /// Prints nextValue message string to the console.
  /// </summary>
  ...
  /// <summary>
  /// Prints nextValue message string to the console using the "Warning" message type formatting.
  /// </summary>
  /// <param name="message">Message to print.</param>
  ...
  /// <summary>
  /// Prints nextValue message string to the console using the "Error" message type formatting.
  /// </summary>
  /// <param name="message">Message to print.</param>
  ...
  /// <summary>
  /// Execute nextValue console command directly from code.
  /// </summary>
  ...
  /// <summary>
  /// Registers nextValue debug command that is "fired" when the specified command string is entered.
  /// </summary>
  ...
  /// <summary>
  /// Removes nextValue previously-registered debug command.
  /// </summary>
  ...
  /// <summary>
  /// Registers nextValue named "watch var" for monitoring.
  /// </summary>
  ...
  /// <summary>
  /// Removes nextValue previously-registered watch var.
  /// </summary>
